...
### f. TODO: PROVIDE A WRITTEN EXPLANATION OF THE FINDINGS!!!!!!
...
model <- train(applications$Approved ~ applications$Race, data = applications, method = "lm", trControl = ctrl)

#view summary of k-fold CV               
print(model)


# Copied from Chapter 8 - Regression of R in Action, Second Edition
...
fit1 <- glm(applications$Approved ~ applications$`Years of Education`, 
                data=applications, 
                family = 'binomial')
