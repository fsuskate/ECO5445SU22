...
result <- gamlr(training_data_matrix, as.factor(training_response),  verb=TRUE, family='binomial')
plot(result)
```

### b. Perform 10 fold cross validation
```{r}
cv.result <- cv.gamlr(training_data_matrix, as.factor(training_response), verb=TRUE,nfold =10)
